...
class TestUtil(unittest.TestCase):
    ...
    def test_sort_app_data(self):
        data_obj = [{'name':'2','group':"A"},{'name':'3','group':'B'},{'name':'','group':'B'},{'name':'1','group':'A'}]
        order = ['2','B']
        target1 = iter([{'name':'3','group':'B'},{'name':'2','group':"A"},{'name':'1','group':'A'}])
        target2 = iter([{'name':'2','group':"A"},{'name':'1','group':'A'},{'name':'3','group':'B'}])
